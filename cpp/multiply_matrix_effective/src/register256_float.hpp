...
inline __m256 fma8( __m256 acc, const DataT* p1, const DataT* p2 )
{
...
template<int offsetRegs, typename DataT>
inline auto fma8rem( __m256 acc, const DataT* p1, const DataT* p2, ptrdiff_t rem )
{
    constexpr ptrdiff_t lanes = offsetRegs * 8;
...
void registers256_float(const matrix& left, const matrix& right, matrix& result)
{
